...
public final class CommonCustomUserDataMavenExtension extends AbstractMavenLifecycleParticipant {
    ...
    public void afterProjectsRead(MavenSession session) throws MavenExecutionException {
        ...
        BuildScanApi buildScan = lookupBuildScanExtension(session);
        if (buildScan == null) {
            return;
        }
    ...
    private static BuildScanApi lookupBuildScanExtension(MavenSession session) throws MavenExecutionException {
        try {
