...
final class Utils {
    ...
    static void captureProperty(BuildScanConfigurable buildScan, String name, String value, Supplier<String> getDevelocityServer) {
        buildScan.tag(value);
        buildScan.value(name, value);
        capturePropertyLink(buildScan, name, value, getDevelocityServer);
    }

    static void capturePropertyError(BuildScanConfigurable buildScan, String name, String message) {
        buildScan.value(name + " error", "Property not captured because: " + message);
    }

    private static void capturePropertyLink(BuildScanConfigurable buildScan, String name, String value, Supplier<String> getDevelocityServer) {
