...
public final class GradleBuildScanConfigurable implements BuildScanConfigurable {
    ...
    public BuildScanObfuscationConfigurable getObfuscation() {
        return new GradleBuildScanObfuscationConfigurable(buildScan.getObfuscation());
    }

    @Override
    public BuildScanCaptureConfigurable getCapture() {
        return new GradleBuildScanCaptureConfigurable(buildScan.getCapture());
    }

    @Override
    public BuildScanPublishingConfigurable getPublishing() {
        return new GradleBuildScanPublishingConfigurable(buildScan.getPublishing());
    }
